...
namespace Game2
{
    partial class level1
    {
        ...
        private void InitializeWidget(LayoutOrientation orientation)
        {
            ...
            // ImageBox_1
            ImageBox_1.Image = new ImageAsset("/Application/assests/Textures/MenuBackground.png");
        ...
        public void SetWidgetLayout(LayoutOrientation orientation)
        {
            switch (orientation)
            {
                ...
                default:
                    ...
                    ImageBox_1.SetPosition(20, 54);
                    ImageBox_1.SetSize(439, 206);
                    ImageBox_1.Anchors = Anchors.None;
                    ImageBox_1.Visible = true;

                    lblHighscoreText.SetPosition(462, 121);
                    lblHighscoreText.SetSize(133, 36);
                    lblHighscoreText.Anchors = Anchors.None;
                    lblHighscoreText.Visible = true;

                    lblScore.SetPosition(462, 158);
